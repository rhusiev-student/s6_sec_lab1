...
bool Session::connect()
{
    try
    {
        ...
        boost::asio::ip::tcp::resolver::results_type endpoints = boost::asio::ip::tcp::resolver(m_io_service).resolve(m_ip, m_port);
        ...
        boost::asio::async_connect(m_socket, endpoints, boost::lambda::var(ec) = boost::lambda::_1);
